...
def main():
    ...
    STEP_DIR = Path("One-HDR-Ready")

    steps = [
        ("Step 1 — Fetch Sequences",
        ["python3", str(STEP_DIR / "step1_fetch_sequences.py"), gene_id]),

        ("Step 2 — Primer Design + Ranking",
        ["python3", str(STEP_DIR / "step2_design_primers.py")]),

        ("Step 3 — Run CRISPOR",
        ["python3", str(STEP_DIR / "step3_run_crispor.py")]),

        ("Step 4 — Build HDR Arms",
        ["python3", str(STEP_DIR / "step4_build_hdr_arms.py")]),

        ("Step 5 — Verification / Summary",
        ["python3", str(STEP_DIR / "step5_output_results.py")]),

        ("Step 6 — Annotated Visualization",
        ["python3", str(STEP_DIR / "step6_result_visuals.py")]),
    ]
